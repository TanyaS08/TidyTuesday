...
#load map
spdf <- geojson_read("2020/week25_AfricanAmericanHistory/us_states_hexgrid.geojson",  what = "sp")
...
ggsave("2020/week25_AfricanAmericanHistory/StaticMap_nolabels.png", 
       panel_census, 
       height = 7, width = 11, 
       units = "in", dpi = 600)
...
anim_save("animate_nolabels.gif", 
          ...
          path = "2020/week25_AfricanAmericanHistory/")
...
ggsave("2020/week25_AfricanAmericanHistory/StaticMap_WithFirsts.png", 
       panel_firsts, 
       height = 7, width = 11, 
       units = "in", dpi = 600)
...
#'          file = "2020/week25_AfricanAmericanHistory/routes_geocoded.csv")
#' ------------------------------------------------------------------#

slave_routes_paired <- read.csv("2020/week25_AfricanAmericanHistory/routes_geocoded.csv",
                                row.names = 1) %>%
  na.omit()
